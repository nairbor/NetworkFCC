<?php
  ...
  if(!isset($_SESSION['cargo']) || $_SESSION['cargo'] != 1){
    ...
    */
	...
	$query="SELECT Nombre, Fecha, Imagen, Descripcion FROM eventos WHERE InEvent='".$id."'";
  	...
  	<div id="wrapper">
        ...
        <section id="content">
            <div class="container">
                ...
                <div class="row">
                    <form name="registrar" method="POST" action="../../controller/modeventoController.php" enctype="multipart/form-data"  enctype="multipart/form-data" accept="application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint, text/plain, application/pdf, image/*">
